      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 text-center">
        <div className={`transition-all duration-1000 transform ${
          ...
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight">
            {t.hero.title}
            <span className="block mt-2 bg-gradient-to-r from-purple-400 via-pink-400 to-purple-300 bg-clip-text text-transparent">
          ...
          <div className="mt-16 flex flex-wrap justify-center gap-8 text-white">
            <div className="text-center">
              ...
              <div className="text-sm text-gray-300 mt-1">{t.hero.stats.websites}</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-purple-300">100%</div>
              <div className="text-sm text-gray-300 mt-1">{t.hero.stats.satisfaction}</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-purple-300">7-14</div>
              <div className="text-sm text-gray-300 mt-1">{t.hero.stats.delivery}</div>
            </div>
          </div>
        </div>
      </div>
